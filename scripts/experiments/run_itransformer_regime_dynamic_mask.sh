...
RESULTS_BASE_DIR="${RESULTS_BASE_DIR:-${RESULTS_ROOT}/itransformer_regime_transition_weighted_pcmci_k7}"
CHECKPOINT_BASE_DIR="${CHECKPOINT_BASE_DIR:-${CHECKPOINTS_ROOT}/itransformer_regime_transition_weighted_pcmci_k7}"

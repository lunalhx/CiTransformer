...
CAUSAL_GRAPH_DIR="${CAUSAL_GRAPH_DIR:-results/causal_graphs/global_pcmci_11vars_train}"
...
SEED="${SEED:-42}" \
DEVICE="${DEVICE:-auto}" \
RESULTS_BASE_DIR="${RESULTS_BASE_DIR:-results/itransformer_global_pcmci_11vars}" \
CHECKPOINT_BASE_DIR="${CHECKPOINT_BASE_DIR:-checkpoints/itransformer_global_pcmci_11vars}" \
